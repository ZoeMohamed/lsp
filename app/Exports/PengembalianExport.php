...

{
    ...
    public function __construct($tanggal_pengembalian, $identitas)
    {
    ...
    public function query()
    {
        ...
        return Peminjaman::query()->where('tanggal_pengembalian', $this->tanggal_pengembalian);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('B2', $this->tanggal_pengembalian)->getStyle('B2:G2')
                    ->getAlignment()
                    ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);;
