...
<div class="modal fade modal-lg" id="form-pesan1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form form-vertical" action="{{ route('user.kirim_pesan') }}" method="POST">
                    @csrf
                    <div class="form-body">
                        <div class="row">
